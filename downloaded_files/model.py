# -*- coding: utf-8 -*-
"""
Created on Sat Mar  9 15:00:52 2019
...
import numpy as np
from tensorflow.keras.layers import Convolution2D, MaxPool2D, Flatten, LSTM
...
def build_rand_feat():
    ...
    for _ in tqdm(range(n_samples)):
        ...
        rate, wav = wavfile.read('clean1//' +file)
...
def get_conv_model():
    model=Sequential()                  # rectified linear unit
    model.add(Convolution2D(filters=16, kernel_size=(3,3), activation='relu', strides=(1,1),
    ...
    model.add(Convolution2D(64, (3,3), activation='relu', strides=(1,1),
                     padding='same'))
    model.add(Convolution2D(128, (3,3), activation='relu', strides=(1,1),
                     padding='same'))
